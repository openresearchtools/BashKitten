...
async function handler(req, res) {
  try {
    ...
    if (route === '/api/control') {
      ...
      if (!['status', 'start', 'stop', 'restart', 'pi-stop', 'pi-kill', 'package-job', 'desktop-settings', 'desktop-start', 'desktop-stop'].includes(value.command)) throw Error('Unknown control action');
