...
import { isPrivateBrowsingContext } from "resource:///modules/BashKittenBlockerUtils.sys.mjs";
 ...
 */
export class BashKittenBlockedPageParent extends JSWindowActorParent {
  receiveMessage(message) {
    if (message.name !== "BashKittenBlockedPage:AllowAndNavigate") {
      return undefined;
    }
    ...
    if (
      !BashKittenBlockerService.wasHostBlockedFor(browserId, hostname, url)
    ) {
      return false;
    }
