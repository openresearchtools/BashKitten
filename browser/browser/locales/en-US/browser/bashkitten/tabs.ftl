...
bashkitten-tabs-position-heading =
    .label = Toolbar positions

bashkitten-tabs-tab-bar-position-select =
    .label = Tab bar position

bashkitten-tabs-tab-bar-option-top-above =
    .label = Above the navigation toolbar

bashkitten-tabs-tab-bar-option-top-below =
    .label = Below the navigation toolbar

bashkitten-tabs-tab-bar-option-bottom-above =
    .label = At the bottom, above the status bar

bashkitten-tabs-tab-bar-option-bottom-below =
    .label = At the bottom, below the status bar

bashkitten-tabs-bookmarks-bar-position-select =
    .label = Bookmarks toolbar position

bashkitten-tabs-bookmarks-bar-option-top =
    .label = Top

bashkitten-tabs-bookmarks-bar-option-bottom =
    .label = Bottom

bashkitten-tabs-menu-heading =
    .label = Tab context menu

bashkitten-tabs-duplicate-menu-toggle =
    .label = Show the duplicate tab entry

bashkitten-tabs-copy-url-menu-toggle =
    .label = Show the copy tab URL entry

bashkitten-tabs-copy-active-url-toggle =
    .label = Copy the URL of the active tab instead of the clicked tab

bashkitten-tabs-copy-all-urls-menu-toggle =
    .label = Show the copy all tab URLs entry

bashkitten-tabs-restart-heading =
    .label = Restarting

bashkitten-tabs-restart-menu-toggle =
    .label = Show a restart entry in the menus

bashkitten-tabs-restart-confirm-toggle =
    .label = Ask for confirmation before restarting

bashkitten-tabs-restart-clear-cache-toggle =
    .label = Clear the startup cache when restarting

bashkitten-tabs-display-heading =
    .label = Tab display

bashkitten-tabs-pinned-icon-only-toggle =
    .label = Shrink pinned tabs to just the site icon

bashkitten-tabs-hide-close-buttons-toggle =
    .label = Hide the close button on tabs

bashkitten-tabs-grouping-heading =
    .label = Automatic tab grouping

bashkitten-tabs-auto-group-toggle =
    .label = Group new tabs with the tab that opened them

bashkitten-tabs-auto-group-placement-select =
    .label = Where new tabs join the group

bashkitten-tabs-auto-group-placement-option-after =
    .label = After the tab that opened them

bashkitten-tabs-auto-group-placement-option-first =
    .label = At the start of the group

bashkitten-tabs-auto-group-placement-option-last =
    .label = At the end of the group

bashkitten-copy-url-notification = URL copied
