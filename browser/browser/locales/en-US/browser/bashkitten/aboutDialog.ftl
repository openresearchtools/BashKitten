...
aboutdialog-community = { -brand-short-name } is an open-source browser for people and external agents. Browse normally or use the bashkitten shell command to control tabs, pages and downloads. Developed transparently by <label data-l10n-name="project-link">its contributors</label>, with no project telemetry or commercial service integrations.
