...
// Exact default light/dark palette from BashKittenThemeColors.sys.mjs.
internal fun bashKittenScheme(theme: Theme) = if (theme == Theme.Light) {
...
internal fun bashKittenColors(theme: Theme) = if (theme == Theme.Light) {
...
internal fun bashKittenGradients(theme: Theme): AcornGradientScheme {
