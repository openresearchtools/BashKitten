...
p=ROOT/'bashkitten/android/ui-artwork.json'
...
for name in ('ic_launcher-web.webp','ic_launcher_private-web.webp'):
 ...
 inventory['resources'][rel]={'sha256':hashlib.sha256(data).hexdigest(),'type':'.webp','action':'remove unused upstream store artwork; launcher uses BashKitten logo'}
