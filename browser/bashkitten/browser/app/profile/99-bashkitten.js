...
// BashKitten has no product telemetry, experiments, sponsored content,
...
// implicit connection to a Mozilla, Waterfox, or BashKitten service.
...
pref("toolkit.telemetry.server_owner", "BashKitten", locked);
...
pref(
  ...
  "https://accounts.bashkitten.invalid/",
  locked
);
pref(
  "identity.fxaccounts.auth.uri",
  "https://accounts.bashkitten.invalid/auth/v1",
  locked
);
pref(
  "identity.fxaccounts.remote.profile.uri",
  "https://accounts.bashkitten.invalid/profile/v1",
  locked
);
pref(
  "identity.fxaccounts.remote.oauth.uri",
  "https://accounts.bashkitten.invalid/oauth/v1",
  locked
);
pref(
  "identity.fxaccounts.remote.pairing.uri",
  "wss://accounts.bashkitten.invalid/pair",
  locked
);
pref(
  "identity.sync.tokenserver.uri",
  "https://accounts.bashkitten.invalid/sync/1.5",
  locked
);
...
// The native BashKitten blocker remains active; a locally maintained malware
...
// Agent and ordinary tabs share one browser window and profile.
pref("browser.tabs.closeWindowWithLastTab", false, locked);
pref("browser.profiles.enabled", false, locked);
pref("browser.profiles.editProfile.enabled", false, locked);
pref("browser.link.open_newwindow", 3, locked);
pref("browser.link.open_newwindow.restriction", 0, locked);
pref("browser.link.open_newwindow.override.external", 3, locked);
