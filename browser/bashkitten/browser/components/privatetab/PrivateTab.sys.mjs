...
const CSS_URI =
  "chrome://browser/content/bashkitten/privatetab/privatetab.css";
...
export const PrivateTab = {
  ...
  _markPrivateTab(tab) {
    tab.toggleAttribute("bashkitten-private", true);
  ...
  _initMenus(win) {
    ...
    // webext-panels.xhtml does not load browser/bashkitten/private-tabs.ftl;
    ...
    // browser.xhtml supplies browser/bashkitten/private-tabs.ftl here.
