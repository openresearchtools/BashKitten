...
export const BASHKITTEN_THEME_MODE_PREF = "browser.theme.bashkitten.mode";
export const BASHKITTEN_THEME_COLOR_PREF = "browser.theme.bashkitten.color";
export const BASHKITTEN_THEME_ID =
  "bashkitten-dynamic-theme@bashkitten.invalid";
...
const IN_CONTENT_THEME_EXPERIMENT = Object.freeze({
  colors: {
    bashkitten_accent_primary: "--color-accent-primary",
    bashkitten_accent_primary_hover: "--color-accent-primary-hover",
    bashkitten_accent_primary_active: "--color-accent-primary-active",
    bashkitten_background_color_information: "--background-color-information",
    bashkitten_icon_color_information: "--icon-color-information",
  },
});

const PALETTES = {
  default: {
    labelId: "bashkitten-onboarding-color-default-label",
    swatch:
    ...
    content: {
      light: {
        bashkitten_accent_primary: "#4a4a4a",
        bashkitten_accent_primary_hover: "#363636",
        bashkitten_accent_primary_active: "#292929",
        bashkitten_background_color_information: "#e6e6e6",
        bashkitten_icon_color_information: "#4a4a4a",
      },
      dark: {
        bashkitten_accent_primary: "#c8c8c8",
        bashkitten_accent_primary_hover: "#d8d8d8",
        bashkitten_accent_primary_active: "#e6e6e6",
        bashkitten_background_color_information: "#292929",
        bashkitten_icon_color_information: "#d8d8d8",
      },
    },
  },
  smoke: {
    labelId: "bashkitten-onboarding-color-smoke-label",
    swatch:
  ...
  ash: {
    labelId: "bashkitten-onboarding-color-ash-label",
    swatch:
  ...
  sun: {
    labelId: "bashkitten-onboarding-color-sun-label",
    swatch:
  ...
  spark: {
    labelId: "bashkitten-onboarding-color-spark-label",
    swatch:
  ...
  flame: {
    labelId: "bashkitten-onboarding-color-flame-label",
    swatch:
  ...
  flare: {
    labelId: "bashkitten-onboarding-color-flare-label",
    swatch:
  ...
  lavender: {
    labelId: "bashkitten-onboarding-color-lavender-label",
    swatch:
  ...
  dusk: {
    labelId: "bashkitten-onboarding-color-dusk-label",
    swatch:
  ...
  lagoon: {
    labelId: "bashkitten-onboarding-color-lagoon-label",
    swatch:
  ...
  tide: {
    labelId: "bashkitten-onboarding-color-tide-label",
    swatch:
  ...
  pine: {
    labelId: "bashkitten-onboarding-color-pine-label",
    swatch:
...
function deriveInContentColors(colors, variant) {
  ...
  return {
    bashkitten_accent_primary: accent,
    bashkitten_accent_primary_hover: mixHexColor(
      accent,
      contrastMixColor,
      0.12
    ),
    bashkitten_accent_primary_active: mixHexColor(
      accent,
      contrastMixColor,
      0.24
    ),
    bashkitten_background_color_information: mixHexColor(
      accent,
      subtleMixColor,
      isLight ? 0.88 : 0.62
    ),
    bashkitten_icon_color_information: accent,
  };
}
...
export const BashKittenThemeColors = {
  _initialized: false,
  ...
  init() {
    ...
    Services.prefs.addObserver(BASHKITTEN_THEME_MODE_PREF, this);
    Services.prefs.addObserver(BASHKITTEN_THEME_COLOR_PREF, this);
    Services.prefs.addObserver(ACTIVE_THEME_PREF, this);
    Services.obs.addObserver(this, THEME_UPDATE_TOPIC);

    if (
      Services.prefs.prefHasUserValue(BASHKITTEN_THEME_COLOR_PREF) &&
      normalizeColor(
        Services.prefs.getStringPref(BASHKITTEN_THEME_COLOR_PREF)
      ) == DEFAULT_COLOR
    ) {
      Services.prefs.clearUserPref(BASHKITTEN_THEME_COLOR_PREF);
    }
  ...
  uninit() {
    ...
    Services.prefs.removeObserver(BASHKITTEN_THEME_MODE_PREF, this);
    Services.prefs.removeObserver(BASHKITTEN_THEME_COLOR_PREF, this);
  ...
  getMode() {
    return normalizeMode(
      Services.prefs.getStringPref(BASHKITTEN_THEME_MODE_PREF, DEFAULT_MODE)
    );
  },

  getColor() {
    return normalizeColor(
      Services.prefs.getStringPref(BASHKITTEN_THEME_COLOR_PREF, DEFAULT_COLOR)
    );
  },

  setMode(mode) {
    Services.prefs.setStringPref(
      BASHKITTEN_THEME_MODE_PREF,
      normalizeMode(mode)
    );
    return this.apply();
  },
  ...
  setColor(color) {
    ...
    if (color == DEFAULT_COLOR) {
      if (Services.prefs.prefHasUserValue(BASHKITTEN_THEME_COLOR_PREF)) {
        Services.prefs.clearUserPref(BASHKITTEN_THEME_COLOR_PREF);
      }
      return this.apply();
    }

    Services.prefs.setStringPref(BASHKITTEN_THEME_COLOR_PREF, color);
    return this.apply();
  },
