...
// BashKitten ships Safe Browsing off by policy, so the security status card must
...
function wrapSafeBrowsingWarning(config) {
  if (config._bashkittenSafeBrowsing || !config.prefMapping) {
    return;
  }
  config._bashkittenSafeBrowsing = true;
