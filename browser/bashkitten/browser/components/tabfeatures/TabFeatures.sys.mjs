...
const CSS_URI =
  "chrome://browser/content/bashkitten/tabfeatures/tabfeatures.css";
...
export const TabFeatures = {
  ...
  async _showCopyNotification(win, url) {
    try {
      const l10n = new Localization(["browser/bashkitten/tabs.ftl"], true);
      const title = l10n.formatValueSync("bashkitten-copy-url-notification");
